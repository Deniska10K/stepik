...
color1, color2 = (input() for i in range(2))
if color1 == color2 and color1 in ['желтый', 'красный', 'синий']:
    print(color1)
elif sorted([color1, color2]) == ['красный', 'синий']:
    print("фиолетовый")
elif sorted([color1, color2]) == ['желтый', 'красный']:
    print("оранжевый")
elif sorted([color1, color2]) == ['желтый', 'синий']:
    print("зеленый")
else:
    print("ошибка цвета")
